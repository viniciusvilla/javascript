    ...
    if(fano.value.length == 0 || fano.value > ano){
       ...
       if(fsex[1].checked){
        ...
        if (idade >=0 && idade <= 3){
            ...
            genero = 'Hora Extra'
            img.src = 'imagens/n.mc2.png'
            res.innerHTML = `Detectamos um filha da puta fazendo ${genero} com ${idade} anos. Se levantar a mão Jesus leva KKKK`
        }
            ...
            if (idade >=0 && idade <= 3){
                ...
                genero = 'Hora Extra'
                img.src = 'imagens/cadaver2.png'
                res.innerHTML = `Detectamos uma filha da puta fazendo ${genero} com ${idade} anos. Se levantar a mão Jesus leva KKKK`
